...
inputt = ATOMSPACE.add_node(types.ArrayNode, str(images))
...
layer_0_en=ReLUConvLayer(filter_size=(7,7),
 ...
 print layer_0_en
first-layer= ATOMSPACE.add_node(types.ArrayNode, str(layer_0_en))
ATOMSPACE.add_link(types.RegionChildLink, [inputt,first-layer])
...
second-layer= ATOMSPACE.add_node(types.ArrayNode, str(layer_0_de))
ATOMSPACE.add_link(types.RegionNeighborLink, [first-layer,second-layer]) 
...
third-layer= ATOMSPACE.add_node(types.ArrayNode, str(layer_1_en))
ATOMSPACE.add_link(types.RegionNeighborLink, [second-layer,third-layer])                                               
