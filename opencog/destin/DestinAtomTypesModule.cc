...
#include "DestinAtomTypesModule.h"
...
DECLARE_MODULE(DestinAtomTypesModule)

DestinAtomTypesModule::DestinAtomTypesModule(CogServer& cs) : Module(cs)
{
}

DestinAtomTypesModule::~DestinAtomTypesModule()
{
}

void DestinAtomTypesModule::init()
{
    logger().info("-------------------------------------------------------");
    DestinAtomTypesTester::createAtoms();
    logger().info("-------------------------------------------------------");
    DestinAtomTypesTester::dumpAtoms();
}
